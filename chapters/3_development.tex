...
\begin{lstlisting}[language=Python, caption=\textit{Funcția de inițializare a bazei de date}]
...
\begin{lstlisting}[language=Python, caption=\textit{Antrenarea modelului}]
